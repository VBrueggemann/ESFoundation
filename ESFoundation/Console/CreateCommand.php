...
class CreateCommand extends Command
{
    ...
    {
        if (! is_dir($directory = app()->path() . DIRECTORY_SEPARATOR . ($this->option('path') ?: 'ES' . DIRECTORY_SEPARATOR . 'Commands'))) {
    ...
    {
        $compiledStub = file_get_contents(__DIR__.'/stubs/Command.stub');
