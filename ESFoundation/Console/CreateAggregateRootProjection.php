...
class CreateAggregateRootProjection extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'make:aggregateRootProjection
                            {--N|name=AggregateRootProjection : Class Name}
     ...
     * @var string
     */
    protected $description = 'Create a new AggregateRootProjection';
    ...
    {
        $compiledStub = file_get_contents(__DIR__.'/stubs/AggregateRootProjection.stub');
